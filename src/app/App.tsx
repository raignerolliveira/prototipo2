...
import { ProfessionalDashboard } from "@/app/components/professional-dashboard";
import { Toaster } from "@/app/components/ui/sonner";
import { Proposal } from "@/app/types";

type Page = "auth" | "home" | "professional-dashboard" | "profile" | "chat" | "checkout" | "completion" | "success";
...
function AppContent() {
  ...
  const handleLogin = () => {
    // Direcionar para dashboard apropriado baseado no tipo de usuário
